            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col text-center">
                    <a href="income_page.php"><img src="icon/income.png" width="57px" />
                      <p>Add Income</p>
                    </a>
                  </div>
                  <div class="col text-center">
                    <a href="manage_expense.php"><img src="icon/mng.png" width="57px" />
                      <p>Manage Expenses</p>
                    </a>
                  </div>
                  <div class="col text-center">
                    <a href="manage_income.php"><img src="icon/mincome.png" width="57px" />
                      <p>Manage Income</p>
                    </a>
                  </div>
                  <div class="col text-center">
